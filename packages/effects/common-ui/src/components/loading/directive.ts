...
import { repoLoading, repoSpinner } from '@repo-core/shadcn-ui';
import { isString } from '@repo-core/shared/utils';
...
const loadingDirective: Directive = {
  mounted(el, binding) {
    const instance = h(repoLoading, getOptions(binding));
    render(instance, el);
...
const spinningDirective: Directive = {
  mounted(el, binding) {
    const instance = h(repoSpinner, getOptions(binding));
    render(instance, el);
