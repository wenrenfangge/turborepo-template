...
import type { ClassType, DeepPartial } from '@repo/types';

import type { BaseFormComponentType, repoFormProps } from '@repo-core/form-ui';
...
export interface SetupVxeTable {
  ...
  userepoForm: typeof userepoForm;
}
