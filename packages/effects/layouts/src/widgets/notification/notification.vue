...
import { Bell, MailCheck } from '@repo/icons';
  ...
  >
    <template #trigger>
      <div class="flex-center mr-2 h-full" @click.stop="toggle()">
        <repoIconButton class="bell-button text-foreground relative">
          <span
            v-if="dot"
    ...
    <div class="relative">
      ...
      <repoScrollbar v-if="notifications.length > 0">
      ...
      >
        ...
        <repoButton size="sm" @click="handleViewAll">
