...
import { LockKeyhole } from '@repo/icons';
import { $t, useI18n } from '@repo/locales';
import { storeToRefs, useAccessStore } from '@repo/stores';

import { useScrollLock } from '@repo-core/composables';
import { userepoForm, z } from '@repo-core/form-ui';
import { repoAvatar, repoButton } from '@repo-core/shadcn-ui';
...
const [Form, { form, validate }] = userepoForm(
  reactive({
    commonConfig: {
      hideLabel: true,
    ...
    schema: computed(() => [
      {
        component: 'repoInputPassword' as const,
        componentProps: {
    ...
    <transition name="slide-right">
      ...
      >
        <div class="flex-col-center mb-10 w-[90%] max-w-[300px] px-4">
          <repoAvatar :src="avatar" class="enter-x mb-6 size-20" />
          <div class="enter-x mb-2 w-full items-center">
            <Form />
          </div>
          <repoButton class="enter-x w-full" @click="handleSubmit">
