...
import type { SegmentedItem } from '@repo-core/shadcn-ui';

import { computed, ref } from 'vue';

import { Copy, RotateCw } from '@repo/icons';
import { $t, loadLocaleMessages } from '@repo/locales';
import {
...
import { userepoDrawer } from '@repo-core/popup-ui';
import {
  repoButton,
  repoIconButton,
  repoSegmented,
...
<template>
  <div>
    ...
    >
      ...
      <div class="p-1">
        <repoSegmented v-model="activeTab" :tabs="tabs">
          <template #general>
