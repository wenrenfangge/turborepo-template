...
import type { MenuRecordRaw } from '@repo/types';
...
const [Modal, modalApi] = userepoModal({
  onCancel() {
    modalApi.close();
  },
      ...
      <template #title>
        <div class="flex items-center">
          ...
          <input
            ...
            class="ring-none placeholder:text-muted-foreground w-[80%] rounded-md border border-none bg-transparent p-2 pl-0 text-sm font-normal ring-0 ring-offset-transparent outline-none focus-visible:ring-transparent"
          />
        </div>
      </template>
