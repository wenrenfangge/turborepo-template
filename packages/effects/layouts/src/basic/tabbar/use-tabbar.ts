...
import type { TabDefinition } from '@repo/types';

import type { IContextMenuItem } from '@repo-core/tabs-ui';

import { computed, ref, watch } from 'vue';
import { useRoute, useRouter } from 'vue-router';

import { useContentMaximize, useTabs } from '@repo/hooks';
import {
  ArrowLeftToLine,
  ArrowRightLeft,
  ArrowRightToLine,
...
import { getTabKey, useAccessStore, useTabbarStore } from '@repo/stores';
import { filterTree } from '@repo/utils';
