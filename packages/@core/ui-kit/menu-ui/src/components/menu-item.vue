...
import { useNamespace } from '@repo-core/composables';
import { repoIcon, repoTooltip } from '@repo-core/shadcn-ui';
  ...
  >
    ...
    >
      <template #trigger>
        <div :class="[nsMenu.be('tooltip', 'trigger')]">
          <repoIcon :class="nsMenu.e('icon')" :icon="menuIcon" fallback />
          <slot></slot>
    ...
    <div v-show="!showTooltip" :class="[e('content')]">
      <MenuBadge
        ...
        v-bind="props"
      />
      <repoIcon :class="nsMenu.e('icon')" :icon="menuIcon" />
      <slot></slot>
      <slot name="title"></slot>
    </div>
  </li>
