...
import { useForwardPropsEmits } from '@repo-core/composables';
import { ChevronLeft, ChevronRight } from '@repo-core/icons';
import { repoScrollbar } from '@repo-core/shadcn-ui';
...
const props = withDefaults(defineProps<Props>(), {
  contentClass: 'repo-tabs-content',
  draggable: true,
  styleType: 'chrome',
  wheelable: true,
});
