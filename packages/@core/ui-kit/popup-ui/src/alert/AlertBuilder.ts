...
import type { Recordable } from '@repo-core/typings';

import type { AlertProps, BeforeCloseScope, PromptProps } from './alert';

import { h, nextTick, ref, render } from 'vue';

import { useSimpleLocale } from '@repo-core/composables';
import { Input, repoRenderContent } from '@repo-core/shadcn-ui';
import { isFunction, isString } from '@repo-core/shared/utils';
...
export function repoAlert(options: AlertProps): Promise<void>;
export function repoAlert(
  message: string,
...
export function repoConfirm(options: AlertProps): Promise<void>;
...
export function repoConfirm(
  ...
  if (!arg1) {
    return isString(arg0)
      ? repoAlert(arg0, defaultProps)
      : repoAlert({ ...defaultProps, ...arg0 });
  } else if (!arg2) {
    return isString(arg1)
      ? repoAlert(arg0 as string, arg1, defaultProps)
      : repoAlert(arg0 as string, { ...defaultProps, ...arg1 });
  }
  return repoAlert(arg0 as string, arg1 as string, {
    ...defaultProps,
    ...arg2,
  });
}

export async function repoPrompt<T = any>(
  ...
  staticContents.push(h(repoRenderContent, { content, renderBr: true }));
