...
import { CircleAlert } from '@repo-core/icons';
import {
  FormControl,
  FormDescription,
  FormField,
...
import { cn, isFunction, isObject, isString } from '@repo-core/shared/utils';
...
<template>
  ...
  >
    ...
    >
      ...
      >
        <template v-if="label">
          <repoRenderContent :content="label" />
        </template>
      </FormLabel>
      <div class="flex-auto overflow-hidden p-[1px]">
        <div :class="cn('relative flex w-full items-center', wrapperClass)">
          ...
          <div v-if="suffix" class="ml-1">
            <repoRenderContent :content="suffix" />
          </div>
          <FormDescription v-if="description" class="ml-1">
            <repoRenderContent :content="description" />
          </FormDescription>
        </div>
