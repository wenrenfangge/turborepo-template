...
import type { repoButtonProps } from '@repo-core/shadcn-ui';
import type { ClassType, MaybeComputedRef } from '@repo-core/typings';
...
export interface ActionButtonOptions extends repoButtonProps {
  [key: string]: any;
...
export type ExtendedFormApi = FormApi & {
  useStore: <T = NoInfer<repoFormProps>>(
    selector?: (state: NoInfer<repoFormProps>) => T,
  ) => Readonly<Ref<T>>;
};

export interface repoFormAdapterOptions<
  T extends BaseFormComponentType = BaseFormComponentType,
> {
  config?: {
